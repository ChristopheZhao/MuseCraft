...
export const zh: Dict = {
  ...
  'export.export': '导出',
  'export.downloadCurrent': '下载当前成片',
  'export.copyLink': '复制链接',
  'export.share': '分享至社交媒体',
  'export.notReady.title': '视频尚未就绪',
  'export.notReady.desc': '视频仍在生成中，完成后即可进行导出。',
  'export.header': '导出与分享',
  'export.headerDesc': '下载当前生成完成的成片，或复制链接继续分发',
  'export.ready': '可导出',
  'export.currentFile.title': '当前可下载文件',
  'export.currentFile.desc': 'Sprint 1 只交付当前成片下载，不在前端伪装多规格转码导出能力。',
  ...
  'export.notify.downloadStarted.title': '下载已开始',
  'export.notify.downloadStarted.msg': '浏览器正在下载 {filename}',
  'export.notify.downloadFailed.title': '下载失败',
  'export.notify.downloadFailed.msg': '当前成片下载失败，请稍后重试',
...
export const en: Dict = {
  ...
  'export.downloadCurrent': 'Download current render',
  ...
  'export.headerDesc': 'Download the current finished render or copy a share link',
  'export.ready': 'Ready to Export',
  'export.currentFile.title': 'Current downloadable file',
  'export.currentFile.desc': 'Sprint 1 only delivers download of the current finished render. The frontend should not pretend multi-format transcoding exists.',
  ...
  'export.notify.downloadStarted.title': 'Download started',
  'export.notify.downloadStarted.msg': 'The browser is downloading {filename}',
  'export.notify.downloadFailed.title': 'Download failed',
  'export.notify.downloadFailed.msg': 'Failed to download the current render. Please try again.',
